      ...
      <section className="bg-green-700 py-20 text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <p className="text-green-100 text-lg max-w-2xl">
            Serving the farmers of Challakere for over 45 years with trust,
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-2xl shadow-xl border border-gray-100 max-w-[280px]">
              ...
              <p className="text-gray-800 font-medium">
                One of the first authorized dealers in the region.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-gray-900">
                Sri Lakshmi Narasimha Swamy Traders
              </h2>
              <p className="text-gray-600 leading-relaxed text-lg">
                Established in 1980 by **G Madhusudhan**, SLNS Traders was
                founded on the principle that every farmer deserves access to
                top-grade agricultural inputs. At a time when quality seeds were
                hard to find, we bridged the gap, bringing global agricultural
                brands to the heart of Challakere.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-xs text-gray-500">
                  Official distributor for brands like Jai Kishan & Kaveri
                  Seeds.
                </p>
              </div>
              <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-xs text-gray-500">
                  A family-run business rooted in the soil of Karnataka.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 border-l-4 border-green-600 pl-6 bg-green-50 py-6 pr-6 rounded-r-xl">
              ...
              <p className="text-gray-700 italic">
                "To provide scientifically proven, high-quality agricultural
                products that ensure sustainable growth and prosperity for the
                hardworking farmers of our community."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Serving Challakere & Nearby Regions
          </h2>
          <p className="text-gray-600 mb-12 max-w-xl mx-auto">
            We are strategically located to serve wholesale and retail buyers
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <span
                key={area}
                className="px-6 py-3 bg-white rounded-full shadow-sm border border-gray-200 text-gray-700 font-medium"
              >
                {area}
              </span>
            ))}
